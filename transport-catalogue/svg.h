...
//	Реализует паттерн "Шаблонный метод" для вывода содержимого тега
	...
	// В PathProps содержатся свойства управления параметрами заливки и контура
...
//	Шаблоны для Элементов <circle>, <polyline>, <text> взяты  https://developer.mozilla.org/en-US/docs/Web/SVG/Element/
	...
	public:
		...
		void RenderSVG(std::ostream& out, int StopBusCount) const;
	private:
